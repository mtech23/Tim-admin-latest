...
export const ChapterManagement = () => {
  ...
  const bookData = () => {
    const LogoutData = localStorage.getItem('login');
    document.querySelector('.loaderBox').classList.remove("d-none");
    fetch('https://custom.mystagingserver.site/Tim-WDLLC/public/api/admin/book_listing',
      {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
  ...
  useEffect(() => {
    document.title = 'Tim Admin | Chapter Management';
    bookData()
                            ...
                            <td>
                              <Dropdown className="tableDropdown">
                                ...
                                <Dropdown.Menu align="end" className="tableDropdownMenu">
                                  ...
                                  {/* <Link to={`/chapter-management/edit-chapter/${item?.id}`} className="tableAction"><FontAwesomeIcon icon={faEdit} className="tableActionIcon" />Edit</Link> */}
