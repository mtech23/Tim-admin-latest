...
import { LanguageManagement } from "../Screens/LanguageManagement";

 
// import { EditLanguage } from "../Screens/LanguageManagement/EditLanguage";
// import { AddLanguage } from "../Screens/LanguageManagement/AddLanguage";
// import { LanguageDetails } from "../Screens/LanguageManagement/LanguageDetails";
  ...
  return (
    <BrowserRouter basename="/TimAdmin">
      <Routes>
        ...
        {/* <Route path="/language-management" element={<ProtectedRoutes Components={LanguageManagement} />} /> */}


        <Route path="/language-management" element={<ProtectedRoutes Components={LanguageManagement} />} />
        {/* <Route path="/add-language" element={<ProtectedRoutes Components={AddLanguage} />} />
        <Route path="/language-management/language-details/:id" element={<ProtectedRoutes Components={LanguageDetails} />} />
        <Route path="/language-management/edit-language/:id" element={<ProtectedRoutes Components={EditLanguage} />} /> */}
